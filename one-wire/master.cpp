...
void setup() {
    ...
    Serial.println("insert IV (16 byte): ");
    ...
    Serial.println("insert plain text (64 byte): ");
    while (!Serial.available());
    Serial.readBytes(plain, BUF_LEN);

    Serial.println("Plain text data is: ");
    for (int i = 0; i < BUF_LEN; i++)
        Serial.print(plain[i], HEX);
    Serial.println();

    AES_CBC_encrypt_buffer(&ctx, plain, BUF_LEN);

    Serial.println("Ciphertext data is: ");
    for (int i = 0; i < BUF_LEN; i++)
        Serial.print(plain[i], HEX);
    Serial.println();
}
